## Latest Version 3.8.0 - 11 May 2025

-   New : Added storage reconnection system.
-   New : Added admin credentials setup during installation.
-   Update : Updated the app installer with improved standards
-   Fix : Fixed the website title display issue
-   Fix : Fixed link shortening in home page header
-   Fix : Fixed mobile navigation issue on home page
